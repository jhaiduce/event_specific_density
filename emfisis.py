...
def get_filename(scname,date):
    ...
    filename='{scname:s}_density_emfisis_{year:d}{month:02d}{day:02d}_v1.3.10.cdf'.format(scname=scname.lower(),year=date.year,month=date.month,day=date.day)
